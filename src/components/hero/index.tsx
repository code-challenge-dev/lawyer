...
const HeroPage = () => {
  return (
    <>
      <div className="flex flex-col gap-4 items-center font-semibold max-w-[680px] min-h-screen mx-8">
        <h2 className="text-3xl md:text-4xl mb-12 md:mb-4 sm:text-center">
          Máte{' '}
